...
author: dict = scholarly.search_author_id('a80R7JcAAAAJ')
...
shieldio_data_mtl = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['a80R7JcAAAAJ:bEWYMUwI8FkC']['num_citations']}",
}
...
shieldio_data_mnemonics = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['a80R7JcAAAAJ:k_IJM867U9cC']['num_citations']}",
}
...
shieldio_data_aanets = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['a80R7JcAAAAJ:u_35RYKgDlwC']['num_citations']}",
}
...
shieldio_data_e3bm = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['a80R7JcAAAAJ:vV6vV6tmYwMC']['num_citations']}",
}
...
shieldio_data_lst = {
  "schemaVersion": 1,
  "label": "citations",
  "message": f"{author['publications']['a80R7JcAAAAJ:TFP_iSt0sucC']['num_citations']}",
}
